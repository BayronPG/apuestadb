...
- **Tablas del análisis de clase** (empresa, cargo, deporte, usuario, Empleado, log_sesion): material de clase en borrador, no es modelo definitivo; faltan tablas del dominio de apuestas (eventos, equipos, cuotas, apuestas, movimientos de saldo).

## Información pendiente

- Instrucciones del profesor.
- Aprobación del tema.
- Motor de base de datos (PostgreSQL, MySQL, SQL Server, Oracle o SQLite — sin decidir).
